    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
        {workSamples.map((sample, index) => (
          <div key={index}>
            {isMobile ? (
              // Mobile version: Direct card with button
              <div className={`bg-white rounded-xl shadow-md p-6 flex flex-col gap-2 transition-transform duration-200 ease-in-out hover:scale-105 hover:shadow-lg border-l-4 ${sample.borderColor}`}>
                ...
                {/* Row with View Details button and Live View button */}
                <div className="flex items-center gap-3">
                  {/* View Details button for mobile */}
                  <Dialog>
                    <DialogTrigger asChild>
                      <button className="bg-warm-coral text-white px-3 py-1 rounded font-semibold text-sm hover:bg-vibrant-yellow hover:text-dark-text transition-colors duration-200">
                        View Details
                      </button>
                    </DialogTrigger>
              ...
              // Desktop version: HoverCard with hover functionality
              <HoverCard>
